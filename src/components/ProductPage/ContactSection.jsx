  ...
  return (
    ...
    >
      ...
      <article className="flex justify-between gap-2 max-sm:gap-4 my-2 w-full flex-wrap">
        <a
          href={`tel:${"0539383809"}`}
          className="flex max-sm:w-[100%] shadow-md border items-center font-semibold justify-center gap-4 p-4 bg-green-500 text-white rounded-md    px-6"
        >
        ...
        <a
          href={`tel:${"0661100616"}`}
          className="flex max-sm:w-[100%] shadow-md border items-center font-semibold justify-center gap-4 p-4 bg-white text-black rounded-md    px-6"
        >
      ...
      <a
        ...
        className="flex items-center max-sm:w-[100%]  shadow-md border font-semibold pl-[20%] gap-4 p-4 w-full bg-white text-black rounded-md max-sm:text-[14px]  px-6 max-sm:px-4  text-[16px]"
      >
        <img src={mail} alt="phone" />
        casapapel08@gmail.com
      </a>
      <a
        className="flex items-center  shadow-md border font-semibold pl-[20%] max-sm:text-[12px]  gap-4 p-4 w-full bg-white text-black rounded-md max-sm:px-3  px-6 text-[16px]"
